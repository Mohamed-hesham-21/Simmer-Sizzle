...
urlpatterns = [
    ...
    path("chef/<str:username>", views.chef_view, name="chef"),

    # API
    path("api/login", views.login, name="login_api"),
    path("api/register", views.register, name="register_api"),
    path("api/add_recipe", views.add_recipe, name="add_recipe_api"),
    ...
    path("api/add_cuisine", views.add_cuisine, name="add_cuisine_api"),
